...
public final class ItemAppBinding implements ViewBinding {
  ...
  @NonNull
  public final CheckBox cbAppSelected;
  ...
  private ItemAppBinding(@NonNull LinearLayout rootView, @NonNull CheckBox cbAppSelected,
      @NonNull ImageView ivAppIcon, @NonNull TextView tvAppName) {
    this.rootView = rootView;
    this.cbAppSelected = cbAppSelected;
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.cb_app_selected;
      CheckBox cbAppSelected = ViewBindings.findChildViewById(rootView, id);
      if (cbAppSelected == null) {
        break missingId;
      }
      ...
      return new ItemAppBinding((LinearLayout) rootView, cbAppSelected, ivAppIcon, tvAppName);
    }
